...
\begin{footnotesize}
\begin{minted}[linenos, gobble=2,xleftmargin=0.55cm, numbersep=1pt]{cpp}
...
\begin{minted}[linenos, gobble=2,xleftmargin=0.2cm, numbersep=1pt]{cpp}
...
\begin{figure}[h]
    ...
    \includegraphics[width=0.46\textwidth]{/home/daniel/HPC/all_plots/Abbildung_15.png}
    \caption{}
    \label{fig:mein_bild}
\end{figure}
